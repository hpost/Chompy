...
import cc.femto.chompy.data.AppPreferences
import cc.femto.chompy.ui.main.MenuView.Menu.*
import cc.femto.common.extensions.*
import cc.femto.common.ui.ViewPagerAdapter
...
class MainView(context: Context, attrs: AttributeSet) : RelativeLayout(context, attrs) {
    ...
    override fun onFinishInflate() {
        ...
        caviarView = viewPager.inflate(R.layout.view_menu, inflater) as MenuView
        caviarView.menu = CAVIAR
        uberView = viewPager.inflate(R.layout.view_menu, inflater) as MenuView
        uberView.menu = UBER
        sprigView = viewPager.inflate(R.layout.view_menu, inflater) as MenuView
