...
object Scrims {
    ...
    val TOOLBAR_SCRIM = Scrims.makeCubicGradientScrimDrawable(
            Color.argb(102, 0, 0, 0), 9, Gravity.TOP)

    /** transparent to 50% opacity black */
    val PHOTO_SCRIM = Scrims.makeCubicGradientScrimDrawable(
            Color.argb(128, 0, 0, 0), 9, Gravity.BOTTOM)

    /** 60% opacity black to transparent */
    val PHOTO_SCRIM_INVERSE = Scrims.makeCubicGradientScrimDrawable(
