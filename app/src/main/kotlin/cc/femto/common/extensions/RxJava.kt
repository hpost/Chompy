...
fun <T> Observable<Result<T>>.retryAfterErrorResult(attempts: Int = 3): Observable<Result<T>> =
        doOnNext { if (it.isError) throw RuntimeException(it.error()) }
...
//        Timber.e(throwable, string(R.string.error_msg, throwable.error.name))
//    } else {
//        Timber.e(throwable, string(R.string.error_something_wrong_msg))
//    }
//}
